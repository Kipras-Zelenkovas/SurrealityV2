...
export declare class Surreality<TTableSchema extends object = object> {
     ...
     */
    defineTable(base: "SCHEMAFULL" | "SCHEMALESS", options?: TableOptsI): Promise<any | ErrorResponse>;
    /**
     ...
     */
    update(options: UpdateOptionsI<TTableSchema>): Promise<any | ErrorResponse>;
    /**
